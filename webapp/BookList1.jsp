...
<body>
	<div id="templatemo_container">
		...
		<div id="templatemo_content">
			...
			<% List<Book> publisherBook = (List<Book>)request.getAttribute("publisherBook");%>

			<div id="templatemo_content_right">

				<%for(int i = 0; i < publisherBook.size();i++)
        { 
        	Book book = publisherBook.get(i);
        	if(i % 2 == 0)
        	{%>
				<div class="templatemo_product_box">
					...
					<div class="product_info">
						...
						<div class="buy_now_button">
							<a
								href="cartcontroller?action=addCart&bookId=<%=book.getBookId()%>&bookName=<%=book.getBookName()%>&bookQuantity=<%=book.getBookQuantity() %>&bookPrice=<%=book.getBookPrice()%>">All To Cart</a>
						</div>
